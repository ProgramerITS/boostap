            ...
            <div class="col-md-9">
                ...
                <?php 
                    if($_POST){
                            ...
                            $email = $_POST['email'];
                            $pass  = $_POST['pass'];
                            $rs = mysql_query("SELECT * FROM tb_login WHERE email='$email'");
                            $cknum = mysql_num_rows($rs);
                            if(!$cknum){?>
                          ...
                          <?php  
                                    mysql_query("INSERT INTO tb_login (name,email,password) VALUES ('$name','$email','$pass')");

                          }else{  ?>
                                    <div class='alert alert-warning'>
                                    <strong>ข้อมูลไม่ถูกต้องหรืออีเมล์ซ้ำ</strong>
                                            </div><br>
                                            <button type="button" class="btn btn-success"
                                                    onclick="window.location.href='./reg.php'">สมัคใหม่</button>

                                              <button type="button" class="btn btn-warning"
 onclick="window.location.href='../'">หน้าหลัก</button>
                            <?php } ?>
                  <?php  }else{
                        header("Location: ../");
                    }
